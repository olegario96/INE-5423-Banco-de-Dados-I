...
\begin{document}
    ...
    \section{Modelo entidade relacionamento (conceitual)}
        ...
        \includegraphics[scale=0.5]{primeiroQuadrante.png}
        \includegraphics[scale=0.5]{segundoQuadrante.png}
        \includegraphics[scale=0.5]{terceiroQuadrante.png}
        \includegraphics[scale=0.5]{quartoQuadrante.png}
        \includegraphics[scale=0.5]{quintoQuadrante.png}
        \includegraphics[scale=0.5]{sextoQuadrante.png}
        \includegraphics[scale=0.5]{setimoQuadrante.png}
        \includegraphics[scale=0.5]{oitavoQuadrante.png}
        \includegraphics[scale=0.5]{nonoQuadrante.png}
        \includegraphics[scale=0.5]{decimoquadrante.png}
